SELECT Trackables.Id AS TrackablesId, Trackables.RecordVersion, Attachments.PageNumber AS PageNumber, 
    ...
    Attachments.TrackablesRecordVersion, Attachments.ScanDateTime, Volumes.[Name] AS VolumnName
    FROM 
...
ORDER BY Trackables.Id DESC, Trackables.RecordVersion DESC, Attachments.PageNumber, Attachments.PointerId