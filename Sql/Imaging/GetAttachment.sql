...
WHERE (UserLinks.IndexTable = @tableName) 
  ...
  AND (UserLinks.AttachmentNumber {0} @attachmentNumber)
...
ORDER BY UserLinks.AttachmentNumber {1}, Attachments.TrackablesId DESC, Attachments.TrackablesRecordVersion DESC, Attachments.PageNumber ASC